!function(e, t) {
    ...
    function o() {
        setTimeout(function() {
            void 0 !== f && (document.body.style.paddingRight = f, f = void 0), void 0 !== v && (document.body.style.overflow = v, v = void 0)
        })
    }
    ...
    exports.disableBodyScroll = function(r, e) {
        if (c) {
            ...
            if (r && !u.some(function(e) {
                ...
                u = [].concat(n(u), [t]), r.ontouchstart = function(e) {
                    1 === e.targetTouches.length && (s = e.targetTouches[0].clientY)
                }, r.ontouchmove = function(e) {
                    var t, o, n, i;
                    1 === e.targetTouches.length && (o = r, i = (t = e).targetTouches[0].clientY - s, l(t.target) || (o && 0 === o.scrollTop && 0 < i || (n = o) && n.scrollHeight - n.scrollTop <= n.clientHeight && i < 0 ? d(t) : t.stopPropagation()))
            ...
            ! function(e) {
                if (void 0 === f) {
                    ...
                    t && 0 < o && (f = document.body.style.paddingRight, document.body.style.paddingRight = o + "px")
                }
                void 0 === v && (v = document.body.style.overflow, setTimeout(function() {
        ...
        }), a && (document.removeEventListener("touchmove", d, i ? {
            passive: !1
        } : void 0), a = !1), u = [], s = -1) : (o(), u = [])
    }, exports.enableBodyScroll = function(t) {
        if (c) {
            if (!t) return void console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");
            t.ontouchstart = null, t.ontouchmove = null, u = u.filter(function(e) {
                return e.targetElement !== t
            }), a && 0 === u.length && (document.removeEventListener("touchmove", d, i ? {
                passive: !1
            } : void 0), a = !1)
